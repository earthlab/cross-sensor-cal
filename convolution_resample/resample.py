...
def resample(hyperspectral_header_file_path: str, satellite_band_parameter_path: str):
    ...
    if wavelengths is None:
        with open('hyperspectral_bands.json', 'r') as f:
    ...
    for sensor_name, sensor_params in all_sensor_params.items():
        ...
        resampled_hdr_path = os.path.join(resampled_dir, f"{hyperspectral_header_file_path.split('__envi')[0]}_resample_{sensor_name}_masked.hdr")
