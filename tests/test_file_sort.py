...
class TestCategorizeFile(unittest.TestCase):
    ...
    def test_resampled_sensor_files(self):
        ...
        file_obj = NEONReflectanceResampledENVIFile(
            path=Path("test/NEON_D13_NIWO_DP1_20200801_161441_resampled_Landsat_5_TM_envi.img"),
            domain="D13", site="NIWO", date="20200801", time="161441",
            sensor="Landsat_5_TM", suffix="envi"
        )
        ...
        for sensor, expected in sensors_and_expected:
            file_obj = NEONReflectanceResampledENVIFile(
                path=Path(f"test/NEON_D13_NIWO_DP1_20200801_161441_resampled_{sensor}_envi.img"),
                domain="D13", site="NIWO", date="20200801", time="161441",
                sensor=sensor, suffix="envi"
            )
    ...
    def test_resampled_masked_sensor_files(self):
        ...
        file_obj = NEONReflectanceResampledMaskENVIFile(
            path=Path("test/NEON_D13_NIWO_DP1_20200801_161441_resampled_mask_Landsat_5_TM_envi.img"),
            domain="D13", site="NIWO", date="20200801", time="161441",
            sensor="Landsat_5_TM", suffix="envi"
        )
        ...
        file_obj = NEONReflectanceResampledMaskHDRFile(
            path=Path("test/NEON_D13_NIWO_DP1_20200801_161441_resampled_mask_MicaSense_envi.hdr"),
            domain="D13", site="NIWO", date="20200801", time="161441",
            sensor="MicaSense", suffix="envi"
        )
    ...
    def test_reflectance_files(self):
        ...
        file_obj = NEONReflectanceBRDFCorrectedENVIFile(
            ...
            domain="D13", site="NIWO", date="20200801", time="161441", suffix="envi"
        )
        self.assertEqual(categorize_file(file_obj), "Reflectance")
        ...
        file_obj = NEONReflectanceBRDFMaskENVIFile(
            path=Path("test/NEON_D13_NIWO_DP1_20200801_161441_brdf_corrected_mask_envi.img"),
            domain="D13", site="NIWO", date="20200801", time="161441", suffix="envi"
        )
        ...
        file_obj = NEONReflectanceBRDFMaskENVIHDRFile(
            path=Path("test/NEON_D13_NIWO_DP1_20200801_161441_brdf_corrected_mask_envi.hdr"),
            domain="D13", site="NIWO", date="20200801", time="161441", suffix="envi"
        )
        self.assertEqual(categorize_file(file_obj), "Reflectance_Masked")
    ...
    def test_generic_files(self):
        ...
        file_obj = NEONReflectanceAncillaryENVIFile(
            path=Path("test/NEON_D13_NIWO_DP1_20200801_161441_reflectance_ancillary_envi.img"),
            domain="D13", site="NIWO", date="20200801", time="161441"
        )
        self.assertEqual(categorize_file(file_obj), "Generic")
        ...
        file_obj = NEONReflectanceCoefficientsFile(
            path=Path("test/NEON_D13_NIWO_DP1_20200801_161441_reflectance_brdf_coeffs_envi.json"),
            domain="D13", site="NIWO", date="20200801", time="161441",
            correction="brdf", suffix="envi"
        )
        self.assertEqual(categorize_file(file_obj), "Generic")
...
class TestGenerateFileMoveList(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.site1_dir = os.path.join(self.base_folder, "NEON_D13_NIWO_DP1_20200801_161441_reflectance")
        self.site2_dir = os.path.join(self.base_folder, "NEON_D10_RMNP_DP1_20200701_153414_reflectance")
        os.makedirs(self.site1_dir)
        os.makedirs(self.site2_dir)
        
        # Create convolution and standard resample directories
        self.conv_tm_dir = os.path.join(self.base_folder, "Convolution_Reflectance_Resample_Landsat_5_TM")
        self.std_oli_dir = os.path.join(self.base_folder, "Standard_Reflectance_Resample_Landsat_8_OLI")
    ...
    def test_basic_file_sorting(self):
        ...
        self.create_test_file(self.site1_dir, "NEON_D13_NIWO_DP1_20200801_161441_reflectance.h5")
        self.create_test_file(self.site1_dir, "NEON_D13_NIWO_DP1_20200801_161441_reflectance_envi.img")
        self.create_test_file(self.site1_dir, "NEON_D13_NIWO_DP1_20200801_161441_reflectance_envi.hdr")
        self.create_test_file(self.site1_dir, "NEON_D13_NIWO_DP1_20200801_161441_brdf_corrected_envi.img")
        self.create_test_file(self.site1_dir, "NEON_D13_NIWO_DP1_20200801_161441_brdf_corrected_envi.hdr")
        self.create_test_file(self.site1_dir, "NEON_D13_NIWO_DP1_20200801_161441_brdf_corrected_mask_envi.img")
        self.create_test_file(self.site1_dir, "NEON_D13_NIWO_DP1_20200801_161441_brdf_corrected_mask_envi.hdr")
        self.create_test_file(self.site1_dir, "NEON_D13_NIWO_DP1_20200801_161441_config_envi.json")
        self.create_test_file(self.site1_dir, "NEON_D13_NIWO_DP1_20200801_161441_reflectance_ancillary_envi.img")
        ...
        for _, row in df.iterrows():
            ...
            if "_reflectance.h5" in source or "_config_" in source or "_ancillary_" in source:
    ...
    def test_sensor_file_sorting(self):
        ...
        self.create_test_file(self.conv_tm_dir, "NEON_D13_NIWO_DP1_20200801_161441_resampled_Landsat_5_TM_envi.img")
        self.create_test_file(self.conv_tm_dir, "NEON_D13_NIWO_DP1_20200801_161441_resampled_Landsat_5_TM_envi.hdr")
        self.create_test_file(self.conv_tm_dir, "NEON_D13_NIWO_DP1_20200801_161441_resampled_mask_Landsat_5_TM_envi.img")
        self.create_test_file(self.conv_tm_dir, "NEON_D13_NIWO_DP1_20200801_161441_resampled_mask_Landsat_5_TM_envi.hdr")
        
        # Create resampled files in standard directory
        self.create_test_file(self.std_oli_dir, "NEON_D10_RMNP_DP1_20200701_153414_resampled_Landsat_8_OLI_envi.img")
        self.create_test_file(self.std_oli_dir, "NEON_D10_RMNP_DP1_20200701_153414_resampled_Landsat_8_OLI_envi.hdr")
        self.create_test_file(self.std_oli_dir, "NEON_D10_RMNP_DP1_20200701_153414_resampled_mask_Landsat_8_OLI_envi.img")
        self.create_test_file(self.std_oli_dir, "NEON_D10_RMNP_DP1_20200701_153414_resampled_mask_Landsat_8_OLI_envi.hdr")
    ...
    def test_multiple_sites(self):
        ...
        self.create_test_file(self.site1_dir, "NEON_D13_NIWO_DP1_20200801_161441_reflectance_envi.img")
        self.create_test_file(self.site2_dir, "NEON_D10_RMNP_DP1_20200701_153414_reflectance_envi.img")
    ...
    def test_csv_output(self):
        ...
        csv_path = os.path.join(self.dest_folder, "sorted_files", "envi_file_move_list.csv")
    ...
    def test_masked_file_variants(self):
        ...
        self.create_test_file(self.site1_dir, "NEON_D13_NIWO_DP1_20200801_161441_reflectance_envi_masked.img")
        self.create_test_file(self.site1_dir, "NEON_D13_NIWO_DP1_20200801_161441_brdf_corrected_envi_masked.img")
        
        # Create MicaSense resampled files
        self.create_test_file(self.site1_dir, "NEON_D13_NIWO_DP1_20200801_161441_resampled_MicaSense_envi.img")
        self.create_test_file(self.site1_dir, "NEON_D13_NIWO_DP1_20200801_161441_resampled_MicaSense_envi_masked.img")
    ...
    def test_convolution_and_standard_resampled_files(self):
        ...
        sensor_mappings = [
            ...
            (SensorType.MICASENSE_MATCH_TM_ETM, "MicaSense-to-match_TM_and_ETM+", "MicaSense-to-match TM and ETM+"),
            (SensorType.MICASENSE_MATCH_OLI, "MicaSense-to-match_OLI_and_OLI-2", "MicaSense-to-match OLI and OLI-2"),
        ]
        
        for sensor_enum, sensor_file, expected_category in sensor_mappings:
            # Test unmasked resampled ENVI file
            file_obj = NEONReflectanceResampledENVIFile(
                path=Path(f"test/NEON_D13_NIWO_DP1_20200801_161441_resampled_{sensor_file}_envi.img"),
                domain="D13", site="NIWO", date="20200801", time="161441",
                sensor=sensor_file, suffix="envi"
            )
            ...
            file_obj = NEONReflectanceResampledHDRFile(
                path=Path(f"test/NEON_D13_NIWO_DP1_20200801_161441_resampled_{sensor_file}_envi.hdr"),
                domain="D13", site="NIWO", date="20200801", time="161441",
                sensor=sensor_file, suffix="envi"
            )
            self.assertEqual(categorize_file(file_obj), expected_category)
            ...
            file_obj = NEONReflectanceResampledMaskENVIFile(
                path=Path(f"test/NEON_D13_NIWO_DP1_20200801_161441_resampled_mask_{sensor_file}_envi.img"),
                domain="D13", site="NIWO", date="20200801", time="161441",
                sensor=sensor_file, suffix="envi"
            )
            ...
            file_obj = NEONReflectanceResampledMaskHDRFile(
                path=Path(f"test/NEON_D13_NIWO_DP1_20200801_161441_resampled_mask_{sensor_file}_envi.hdr"),
                domain="D13", site="NIWO", date="20200801", time="161441",
                sensor=sensor_file, suffix="envi"
            )
            self.assertEqual(categorize_file(file_obj), f"{expected_category}_Masked")
    ...
    def test_all_sensor_types(self):
        ...
        sensor_files = [
            ...
            ("MicaSense", "MicaSense"),
            ("MicaSense-to-match_TM_and_ETM+", "MicaSense-to-match_TM_and_ETM+"),  # Mixed chars preserved
            ("MicaSense-to-match_OLI_and_OLI-2", "MicaSense-to-match_OLI_and_OLI-2"),  # Mixed chars preserved
        ]
        ...
        for sensor_file, expected_dir in sensor_files:
            ...
            unmasked_rows = df[df["Source Path"].str.contains(f"_resampled_{sensor_file_escaped}_") & 
                              ~df["Source Path"].str.contains("_mask_")]
            self.assertTrue(len(unmasked_rows) > 0, f"No unmasked files found for sensor {sensor_file}")
            for _, row in unmasked_rows.iterrows():
                self.assertIn(f"/{expected_dir}/", row["Destination Path"])
            
            # Check masked sensor files
            masked_rows = df[df["Source Path"].str.contains(f"_resampled_mask_{sensor_file_escaped}_")]
    ...
    def test_comprehensive_sensor_sorting(self):
        ...
        for sensor_file, sensor_dir in sensor_mappings:
            ...
            self.create_test_file(conv_dir, f"NEON_D13_NIWO_DP1_20200801_161441_resampled_{sensor_file}_envi.img")
            self.create_test_file(conv_dir, f"NEON_D13_NIWO_DP1_20200801_161441_resampled_{sensor_file}_envi.hdr")
            self.create_test_file(conv_dir, f"NEON_D13_NIWO_DP1_20200801_161441_resampled_mask_{sensor_file}_envi.img")
            self.create_test_file(conv_dir, f"NEON_D13_NIWO_DP1_20200801_161441_resampled_mask_{sensor_file}_envi.hdr")
            
            # Create in standard directory with different site
            self.create_test_file(std_dir, f"NEON_D10_RMNP_DP1_20200701_153414_resampled_{sensor_file}_envi.img")
            self.create_test_file(std_dir, f"NEON_D10_RMNP_DP1_20200701_153414_resampled_{sensor_file}_envi.hdr")
            self.create_test_file(std_dir, f"NEON_D10_RMNP_DP1_20200701_153414_resampled_mask_{sensor_file}_envi.img")
            self.create_test_file(std_dir, f"NEON_D10_RMNP_DP1_20200701_153414_resampled_mask_{sensor_file}_envi.hdr")
        ...
        for sensor_file, expected_dir in sensor_mappings:
            ...
            unmasked_count = len(df[df["Destination Path"].str.contains(f"/{expected_dir_escaped}/") & 
                                   ~df["Destination Path"].str.contains("_Masked/")])
            self.assertEqual(unmasked_count, 4)  # 2 sites * 2 file types (.img, .hdr)
            
            # Check masked files
            masked_count = len(df[df["Destination Path"].str.contains(f"/{expected_dir_escaped}_Masked/")])
