...
#endmember_library<-sigs[,c(23, 1:6)]
#names(endmember_library)[1] <- c("class")
#names(endmember_library)

# Note: right now, classes include "Non-vegetated & dead" "Woody shrub"   "Evergreen" "Deciduous" "Herbaceous," but need shade class in there

# Landsat = landsat_spatRas
#names(landsat_spatRas)<-names(endmember_library)[2:7]
